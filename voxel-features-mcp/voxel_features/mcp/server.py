...
from voxel_features.mcp.tools.spatial_tools import (
    spatial_add_point, spatial_add_line, spatial_add_box, spatial_query_region,
...
TOOLS = [
    ...
    Tool(
        ...
        description="Fill a 3D axis-aligned bounding box with a feature value (use for stratigraphic horizons, formation volumes, any areal/volumetric feature)",
        inputSchema={
            "type": "object",
            "properties": {
                "name": {"type": "string", "description": "Feature layer name"},
